...
[
  ...
  trad-growers ; highlanders growing only traditional crops
...
to go
  ...
  set trad-growers highlanders with [ cacao-grower? = false ]
  ...
  if new-c-growers > count trad-growers
  [
    set new-c-growers count trad-growers
  ]
  ; the closer to market, the more likely to become c-grower
  if cacao? and ticks > 200
  [
    ask rnd:weighted-n-of new-c-growers trad-growers [ 1 / (market-distance + 0.001)]
    [
      become-cacao-grower
    ]
  ]
  ...
  ;;========Production (trad-growers)========;
  ; choose direction holding most resource within the turtle's vision
  ask trad-growers ; must be done together, prevents converging
  [
    turn-towards-resource
    fd 1
    let NO-CROP patches with [cacao-crop? = false]
    if any? NO-CROP
    ; if trad-growers trapped by cacao farms, jump to NO-CROP
    [
      if cacao-crop? = true
      [
...
to become-cacao-grower
  ;; run by rnd:weighted-n-of new-c-growers trad-growers
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count highlanders with [wealth = 0]"
...
1279
879
wealth of non-commercial-crop-growers
NIL
NIL
0.0
10.0
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot max [wealth] of highlanders with [t-grower? = false and cacao-grower? = false]"
"pen-1" 1.0 0 -2674135 true "" "plot mean [wealth] of highlanders with [t-grower? = false and cacao-grower? = false]"
"pen-2" 1.0 0 -13840069 true "" "plot median [wealth] of highlanders with [t-grower? = false and cacao-grower? = false]"
"pen-3" 1.0 0 -987046 true "" "plot min [wealth] of highlanders with [t-grower? = false and cacao-grower? = false]"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot max [wealth] of highlanders with [cacao-grower? = true]"
"pen-1" 1.0 0 -2674135 true "" "plot mean [wealth] of highlanders with [cacao-grower? = true]"
"pen-2" 1.0 0 -13840069 true "" "plot median [wealth] of highlanders with [cacao-grower? = true]"
"pen-3" 1.0 0 -1184463 true "" "plot min [wealth] of highlanders with [cacao-grower? = true]"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count c-growers"
...
"" ""
PENS
"broke c-growers" 1.0 0 -16777216 true "" "plot count c-growers with [wealth = 0]"
"broke traditional-growers" 1.0 0 -2674135 true "" "plot count highlanders with [wealth = 0 and t-grower? = false and cacao-grower? = false]"
"pen-2" 1.0 0 -13840069 true "" "plot count t-growers with [wealth = 0]"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot max [wealth] of highlanders with [t-grower? = true]"
"pen-1" 1.0 0 -5298144 true "" "plot median [wealth] of highlanders with [t-grower? = true]"
"pen-2" 1.0 0 -13840069 true "" "plot min [wealth] of highlanders with [t-grower? = true]"
